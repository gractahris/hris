...
<?php include "model/employeeDAO.php" ?>
<?php include "model/leaveCreditDAO.php" ?>
<?php include_once "model/timesheetDAO.php" ?>
<?php include_once "model/jobDAO.php" ?>
<?php include_once "model/employeeDeductionDAO.php" ?>
...
<tr>
	...
	<td width="20%"><input type = "text" name="txtSearch" id = "txtSearch" /></td>
	<td width="60%"><input type = "submit" class = "btn btn-pink btn-sm" name="btnSearch" id = "btnSearch" value = "Search" />
	<a href="tbl_employee_detailslist.php" class = "btn btn-yellow btn-sm">Show All</a>
	</td>
</tr>
</table>
</form>
<a class = "btn btn-purple btn-sm" href="tbl_employee_detailsadd.php">Add Employee</a><br/><br/>
<center><b>
<?php
...
<table width="100%" class = "table table-striped table-bordered table-hover">
	<tr>
		...
		<td><center><b></b></center></td>
		<td><center><b></b></center></td>
		<!-- <td><center><b>Leave Credit</b></center></td> -->
		<td><center><b>EMPLOYEE NAME</b></center></td>
<!-- 		<td><center><b>FIRST NAME</b></center></td>
		<td><center><b>MIDDLE NAME</b></center></td>
		<td><center><b>EXT. NAME</b></center></td> -->
		<td><center><b>SEX</b></center></td>
		<td><center><b>SCHEDULE</b></center></td>
		<td><center><b>SALARY</b></center></td>
		<td><center><b>TAX CATEGORY</b></center></td>
		<td><center><b>DATE HIRED</b></center></td>
		<td><center><b>JOB TITLE</b></center></td>
		<td><center><b>JOB DESCRIPTION</b></center></td>
	</tr>

<?php
if(isset($_GET['btnSearch']))
{	$searchVal = $_GET['txtSearch'];
	$getAllEmployee = $employeeDAO->searchEmp($searchVal);
	$getCountEmp = $employeeDAO->countSearchEmp($searchVal);
	
	echo "<center>";
	echo "<b>Total Number of Employees: ".$getCountEmp[0]['countEmp']."</b>";
...
{	
	$getCountEmp = $employeeDAO->getCountEmp();
	// $getAllEmployee = $employeeDAO->getAllEmployee();
	// $getAllEmployee = $employeeDAO->getFilterEmp(0,5);
	echo "<center>";
	echo "<b>Total Number of Employees: ".$getCountEmp[0]['countOfEmp']."</b>";
...
echo "<tr>";
foreach($getAllEmployee as $key => $val)
{
	$employee_id = $val['emp_id'];
	$empLastName = $val['empLastName'];
	$empFirstName = $val['empFirstName'];
	$empMiddleName = $val['empMiddleName'];
	$empExtensionName = $val['empExtensionName'];
	$sex_id = $val['sex_id'];
	$schedule_id = $val['schedule_id'];
	$job_id = $val['job_id'];
	// $salary_id = $val['salary_id'];
	$tax_category_id = $val['tax_category_id'];
	$date_hired = $val['date_hired'];
	
 
	$fullName = $empLastName . ", " . $empFirstName ." " . $empMiddleName." " .$empExtensionName;

	echo "<td>";
	echo "<a class = \"btn btn-primary btn-xs\" href=\"tbl_employee_detailsedit.php?emp_id=".$employee_id." \">&nbsp;&nbsp;Edit</a><br/><br/>";
	echo "</td>";

	echo "<td>";
	echo "<form action=\"tbl_employee_detailslist.php\" method \"GET\">";
	echo "<input type=\"hidden\" id = \"employee_id\" name=\"employee_id\"  value = \"".$employee_id."\" />";
	echo "<input class=\"btn btn-danger btn-xs\" type=\"submit\" name=\"btnDel\" id=\"btnDel\" value=\"Delete\">";
	echo "</form>";
	echo "</td>";

	echo "<td>";
	echo "<center>";
	echo "<a class = \"btn btn-pink btn-xs\" href=\"employee_other_deductionadd.php?emp_id=".$employee_id." \">&nbsp;&nbsp;Other Deductions</a><br/><br/>";
	echo "</center>";
	$employeeDeductionDAO = new employeeDeductionDAO();
	$getOtherDeductionByID = $employeeDeductionDAO->getOtherDeductionByID($employee_id);
		echo "<table>";
			...
			echo "<tr>";
			foreach($getOtherDeductionByID as $key => $val)
			{	
				...
				$d_month = $val['month'];
				$d_year = $val['year'];
				$other_deduction_id = $val['other_deduction_id'];
				$cut_off_id = $val['cut_off_id'];


				echo "<td>";
				// echo " ";
				echo "<a href=\"tbl_other_deduction_edit_n.php?other_deduction_id=$other_deduction_id\">Edit</a>";
				echo "</td>";
	...
	echo "<td>";
	echo "<center>";
	echo "<a class = \"btn btn-success btn-xs\" href=\"tbl_employee_leavecreditlist_n.php?emp_id=".$employee_id." \">&nbsp;&nbsp;Leave Credit</a><br/><br/>";
	$leaveCreditDAO = new leaveCreditDAO();
	$getLeaveCreditBal = $leaveCreditDAO->getLeaveCreditBal($employee_id);
	echo "<table>";
	
	foreach($getLeaveCreditBal as $key=>$val)
	{	
		$emp_leave_credit_id = $val['emp_leave_credit_id'];
		...
		echo "<tr>";
			...
			echo "<td>";
			echo "<a href=\"tbl_employee_leavecredit_edit_n.php?emp_leave_credit_id=$emp_leave_credit_id\">Edit</a>";
			echo "</td>";

			echo "<td>";
			foreach($getLeaveTypeByID as $keyLT => $valLT)
			{
				echo $valLT['leave_type_title'];
	...
	// echo "<td>";
	// echo $empExtensionName;
	// echo "</td>";

	echo "<td>";
	$getSexByID = $employeeDAO->getSexByID($sex_id);
	echo $getSexByID[0]['sex_title'];
	echo "</td>";

	echo "<td>";
	$getScheduleByID = $employeeDAO->getScheduleByID($schedule_id);
	echo $getScheduleByID[0]['schedule_title'];
	echo "</td>";

	echo "<td>";
	
	$getJobByID = $jobDAO->getJobByID($job_id);
	foreach ($getJobByID as $keyJob => $valJob)
	{
		$salary_id =  $valJob['salary_id'];
		$getSalaryByID = $employeeDAO->getSalaryByID($salary_id);
		echo $getSalaryByID[0]['salary_amount'];
	}
	echo "</td>";

	echo "<td>";
	$getTaxCatByID = $employeeDAO->getTaxCatByID($tax_category_id);
	echo $getTaxCatByID[0]['tax_category_title'];
	echo "</td>";

	echo "<td>";
	echo date_format(date_create($date_hired),"M d, Y");
	echo "</td>";

	echo "<td>";
	$getJobByID = $employeeDAO->getJobByID($job_id);
	echo $getJobByID[0]['job_title'];
	echo "</td>";

	echo "<td>";
	echo $getJobByID[0]['job_desc'];
	echo "</td>";
...
{
	$delEmp = $employeeDAO->delEmp($_GET['employee_id']);
	?>

		<script type="text/javascript">
		alert("Delete Succeed !");
		window.location.href = "tbl_employee_detailslist.php";
		</script>
	<?php
}
?>
