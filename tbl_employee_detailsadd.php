...
<body onload= "loadDateHired();">
<form method="POST">
<table width="100%" class = "table table-striped table-bordered table-hover">
<?php
$employeeDAO = new employeeDAO();
$createDTRDAO = new createDTRDAO();
$getMaxEmpID = $employeeDAO->getMaxEmpID();
// echo $getMaxEmpID[0]['maxEmpID'];
echo "<input type=\"hidden\" id = \"employee_id\" name=\"employee_id\" value = \"".$getMaxEmpID[0]['maxEmpID']."\">";
	...
	echo "<tr>";
		...
		echo "<td>";
		echo "EXTENSION NAME (i.e Jr, Sr, I, IV)";
		echo "</td>";

		echo "<td>";
		echo "<input type=\"text\" id = \"ext_name\" name=\"ext_name\">";
		echo "</td>";
	...
	echo "<tr>";
		...
		echo "<td>";
		$getAllSex = $employeeDAO->getAllSex();
		echo "<select id=\"sex_id\" name=\"sex_id\">";
		echo "<option id = \"#\" value = \"\">";
		echo "Please Select";
		echo "</option>";

		foreach($getAllSex as $keySex => $valSex)
		{
			echo "<option id='";
			echo $valSex['sex_id'];
			echo "' value='";
			echo $valSex['sex_id'];
			echo "' >".$valSex['sex_title']."</option>";
		}
		echo "</select>";
		echo "</td>";
	...
	echo "<tr>";
		...
		echo "<td>";
		$getAllSchedule = $employeeDAO->getAllSchedule();
		echo "<select id=\"schedule_id\" name=\"schedule_id\">";
		echo "<option id = \"#\" value = \"\">";
		echo "Please Select";
		echo "</option>";

		foreach($getAllSchedule as $keySched => $valSched)
		{
			echo "<option id='";
			echo $valSched['schedule_id'];
			echo "' value='";
			echo $valSched['schedule_id'];
			echo "' >".$valSched['schedule_title']."</option>";
		}
		echo "</select>";
		echo "</td>";
	...
	//echo "<tr>";
		...
		// echo "<td>";
		// $getAllSalary = $employeeDAO->getAllSalary();
		// echo "<select id=\"salary_id\" name=\"salary_id\">";
		// echo "<option id = \"#\" value = \"\">";
		// echo "Please Select";
		// echo "</option>";

		// foreach($getAllSalary as $keySalary => $valSalary)
		// {
		// 	echo "<option id='";
		// 	echo $valSalary['salary_id'];
		// 	echo "' value='";
		// 	echo $valSalary['salary_id'];
		// 	echo "' >".$valSalary['salary_amount']."</option>";
		// }
		// echo "</select>";
		// echo "</td>";
	...
	echo "<tr>";
		...
		echo "<td>";
		$getAllTaxCat = $employeeDAO->getAllTaxCat();
		echo "<select id=\"tax_category_id\" name=\"tax_category_id\">";
		echo "<option id = \"#\" value = \"\">";
		echo "Please Select";
		echo "</option>";

		foreach($getAllTaxCat as $keyTax => $valTax)
		{
			echo "<option id='";
			echo $valTax['tax_category_id'];
			echo "' value='";
			echo $valTax['tax_category_id'];
			echo "' >".$valTax['tax_category_title']."</option>";
		}
		echo "</select>";
		echo "</td>";
	...
	echo "<tr>";
		...
		echo "<td>";
		echo "<input type=\"text\" id = \"date_hired\" name=\"date_hired\">";
		echo "</td>";
	...
	echo "<tr>";
		...
		echo "<td>";
		$getAllJob = $employeeDAO->getAllJob();
		echo "<select id=\"job_id\" name=\"job_id\">";
		echo "<option id = \"#\" value = \"\">";
		echo "Please Select";
		echo "</option>";

		foreach($getAllJob as $keyJob => $valJob)
		{
			echo "<option id='";
			echo $valJob['job_id'];
			echo "' value='";
			echo $valJob['job_id'];
			echo "' >".$valJob['job_title']."</option>";
		}
		echo "</select>";
		echo "</td>";
	...
	echo "<tr>";
		...
		echo "<td colspan = 2>";
		echo "<center>";
		echo "<input class=\"btn btn-sm btn-purple\" type=\"submit\" name=\"btnSave\" id=\"btnSave\" value=\"Add Employee\">";
		echo "</center>";
		echo "</td>";
...
$empMiddleName = $_POST['middle_name'];
$empExtensionName = $_POST['ext_name'];
$sex_id = $_POST['sex_id'];
...
$salary_id = $getJobByID[0]['salary_id'];
...
if(isset($_POST['btnSave']))
{
	...
	if($empLastName == "" || $empLastName  == NULL)
	{
		?>
			<script>
	...
	if($tax_category_id == "" || $tax_category_id  == NULL)
	{
		?>
			<script>
			alert("Enter Tax Category");
			</script>
		<?php
	}
	...
	if($empFirstName <> "" && $empLastName <> "" && $sex_id <> "" && $tax_category_id <> "" && $date_hired <> "" && $job_id <> "")
	{
		$saveEmp = $employeeDAO->saveEmp($employee_id,$empLastName,
							$empFirstName,
							$empMiddleName,
							$empExtensionName,
							$sex_id,
			...
			if($cMonth <= 7)
			{
				if($cMonth % 2)
				{
					...
					for($cDay = 1; $cDay <= $day31; $cDay++)
					{
						...
						// echo " => ";
						// // echo "<br/>";
						$calDate = $year1 . "-".$cMonth."-".$cDay;
						$createCalDate = date_create($calDate);
						$formatCalDate = date_format($createCalDate,"l");
						// echo $formatCalDate;
						$saveDTR = $createDTRDAO->saveDTR($employee_id, $cMonth,$cDay,$year1,$formatCalDate);
						// echo "<br/>";


						$calDate2017 = $year2 . "-".$cMonth."-".$cDay;
						$createCalDate2017 = date_create($calDate2017);
						$formatCalDate2017 = date_format($createCalDate2017,"l");
						$saveDTR = $createDTRDAO->saveDTR($employee_id, $cMonth,$cDay,$year2,$formatCalDate2017);
		...
		//window.location.href = "tbl_employee_detailsadd.php";
		</script>
	<?php
