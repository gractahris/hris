...
$lib_holiday_view = NULL; // Initialize page object first

class clib_holiday_view extends clib_holiday {
	...
	// Page object name
	var $PageObjName = 'lib_holiday_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["holiday_id"] <> "") {
			$this->RecKey["holiday_id"] = $_GET["holiday_id"];
			$KeyUrl .= "&holiday_id=" . urlencode($this->RecKey["holiday_id"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["holiday_id"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["holiday_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["holiday_id"] <> "") {
				...
				$this->RecKey["holiday_id"] = $this->holiday_id->QueryStringValue;
			} else {
				$sReturnUrl = "lib_holidaylist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "lib_holidaylist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "lib_holidaylist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_lib_holiday\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_lib_holiday',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.flib_holidayview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($lib_holiday_view)) $lib_holiday_view = new clib_holiday_view();

// Page init
$lib_holiday_view->Page_Init();

// Page main
$lib_holiday_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$lib_holiday_view->Page_Render();
?>
...
// Page object
var lib_holiday_view = new ew_Page("lib_holiday_view");
lib_holiday_view.PageID = "view"; // Page ID
var EW_PAGE_ID = lib_holiday_view.PageID; // For backward compatibility

// Form object
var flib_holidayview = new ew_Form("flib_holidayview");

// Form_CustomValidate event
flib_holidayview.Form_CustomValidate = 
...
flib_holidayview.ValidateRequired = true;
<?php } else { ?>
flib_holidayview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
flib_holidayview.Lists["x_holiday_month"] = {"LinkField":"x_month_val","Ajax":null,"AutoFill":false,"DisplayFields":["x_month_val","x_month_title","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
flib_holidayview.Lists["x_holiday_day"] = {"LinkField":"x_day_title","Ajax":null,"AutoFill":false,"DisplayFields":["x_day_title","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
flib_holidayview.Lists["x_holiday_year"] = {"LinkField":"x_year_val","Ajax":null,"AutoFill":false,"DisplayFields":["x_year_val","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $lib_holiday_view->ExportOptions->Render("body") ?>
<?php if (!$lib_holiday_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($lib_holiday_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $lib_holiday_view->ShowPageHeader(); ?>
<?php
$lib_holiday_view->ShowMessage();
?>
<form name="flib_holidayview" id="flib_holidayview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="lib_holiday">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_lib_holidayview" class="table table-bordered table-striped">
...
<?php echo $lib_holiday->holiday_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lib_holiday->holiday_title->Visible) { // holiday_title ?>
	<tr id="r_holiday_title">
		<td><span id="elh_lib_holiday_holiday_title"><?php echo $lib_holiday->holiday_title->FldCaption() ?></span></td>
...
<?php echo $lib_holiday->holiday_title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lib_holiday->holiday_month->Visible) { // holiday_month ?>
	<tr id="r_holiday_month">
		<td><span id="elh_lib_holiday_holiday_month"><?php echo $lib_holiday->holiday_month->FldCaption() ?></span></td>
...
<?php echo $lib_holiday->holiday_month->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lib_holiday->holiday_day->Visible) { // holiday_day ?>
	<tr id="r_holiday_day">
		<td><span id="elh_lib_holiday_holiday_day"><?php echo $lib_holiday->holiday_day->FldCaption() ?></span></td>
...
<?php echo $lib_holiday->holiday_day->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lib_holiday->holiday_year->Visible) { // holiday_year ?>
	<tr id="r_holiday_year">
		<td><span id="elh_lib_holiday_holiday_year"><?php echo $lib_holiday->holiday_year->FldCaption() ?></span></td>
...
<?php echo $lib_holiday->holiday_year->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
flib_holidayview.Init();
</script>
<?php
$lib_holiday_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($lib_holiday->Export == "") { ?>
...
<?php
$lib_holiday_view->Page_Terminate();
?>
