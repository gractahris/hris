...
*/
	...
	// echo "<a href=\"lib_holiday_a_del.php?holiday_id=$holiday_id\" class = \"btn btn-danger btn-sm icon-trash \"></a>";
	echo "<form action=\"lib_holiday_a_list.php\" method = \"GET\">";

	echo "<input type=\"hidden\" id = \"holiday_id\" name=\"holiday_id\"  value = \"".$holiday_id."\" />";
	echo "<input class=\"btn btn-danger btn-sm\" type=\"submit\" name=\"btnDel\" id=\"btnDel\" value=\"Delete\" />";
	echo "</form>";
	echo "</center>";
	echo "</td>";
...
{
	$delHoliday = $holidayDAO->delHoliday($_GET['holiday_id']);
	?>

		<script type="text/javascript">
		alert("Delete Succeed !");
		window.location.href = "lib_holiday_a_list.php";
		</script>
	<?php
} 	
