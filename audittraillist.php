...
class caudittrail_list extends caudittrail {
	...
	function SetupOtherOptions() {
		...
		// $item->Body = "<a class=\"ewAction ewMultiDelete\" href=\"\" onclick=\"ew_SubmitSelected(document.faudittraillist, '" . $this->MultiDeleteUrl . "');return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		// $item->Visible = ($Security->CanDelete());
...
<tr>
	...
	<td><a href="<?php echo $audittrail_list->PageUrl() ?>start=<?php echo $audittrail_list->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a>
	&nbsp;&nbsp;&nbsp;
	</td>
	<?php } ?>
	<?php if ($audittrail_list->Pager->PrevButton->Enabled) { ?>
	<td><a href="<?php echo $audittrail_list->PageUrl() ?>start=<?php echo $audittrail_list->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a>&nbsp;&nbsp;&nbsp;
	</td>
	<?php } ?>
	<?php foreach ($audittrail_list->Pager->Items as $PagerItem) { ?>
		<td<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $audittrail_list->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a>&nbsp;&nbsp;&nbsp;
		</td>
	<?php } ?>
	<?php if ($audittrail_list->Pager->NextButton->Enabled) { ?>
	<td><a href="<?php echo $audittrail_list->PageUrl() ?>start=<?php echo $audittrail_list->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a>&nbsp;&nbsp;&nbsp;
	</td>
	<?php } ?>
	<?php if ($audittrail_list->Pager->LastButton->Enabled) { ?>
	<td><a href="<?php echo $audittrail_list->PageUrl() ?>start=<?php echo $audittrail_list->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a>&nbsp;&nbsp;&nbsp;
	</td>
	<?php } ?>
...
<tr>
	...
	<?php } ?>
	<?php if ($audittrail_list->Pager->PrevButton->Enabled) { ?>
	<td><a href="<?php echo $audittrail_list->PageUrl() ?>start=<?php echo $audittrail_list->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a>&nbsp;&nbsp;&nbsp;</td>
	<?php } ?>
	<?php foreach ($audittrail_list->Pager->Items as $PagerItem) { ?>
		<td<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $audittrail_list->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a>&nbsp;&nbsp;&nbsp;</td>
	<?php } ?>
	<?php if ($audittrail_list->Pager->NextButton->Enabled) { ?>
	<td><a href="<?php echo $audittrail_list->PageUrl() ?>start=<?php echo $audittrail_list->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a>&nbsp;&nbsp;&nbsp;</td>
	<?php } ?>
	<?php if ($audittrail_list->Pager->LastButton->Enabled) { ?>
	<td><a href="<?php echo $audittrail_list->PageUrl() ?>start=<?php echo $audittrail_list->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a>&nbsp;&nbsp;&nbsp;</td>
	<?php } ?>
</tr>
</table>
<!-- </ul> -->
