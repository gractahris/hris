...
class cuserlevels_add extends cuserlevels {
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			$this->userlevelname->PlaceHolder = ew_HtmlEncode(ew_RemoveHtml($this->userlevelname->FldCaption()));
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", "<span id=\"ewPageCaption\">" . $PageCaption . "</span>", "userlevelslist.php", $this->TableVar);
...
?>
<form name="fuserlevelsadd" id="fuserlevelsadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<input type="text" data-field="x_userlevelid" name="x_userlevelid" id="x_userlevelid" size="30" placeholder="<?php echo $userlevels->userlevelid->PlaceHolder ?>" value="<?php echo $userlevels->userlevelid->EditValue ?>"<?php echo $userlevels->userlevelid->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_userlevelname" name="x_userlevelname" id="x_userlevelname" size="30" maxlength="255" placeholder="<?php echo $userlevels->userlevelname->PlaceHolder ?>" value="<?php echo $userlevels->userlevelname->EditValue ?>"<?php echo $userlevels->userlevelname->EditAttributes() ?>>
</span>
