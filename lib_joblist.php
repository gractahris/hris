...
<a class= "btn btn-sm btn-purple" href = "lib_jobadd.php">Add Job</a><br/><br/>
<table width="100%" class = "table table-striped table-bordered table-hover">
	<tr>
		...
		<td><center><b>JOB SALARY</b></center></td>
	</tr>
<?php
$jobDAO = new jobDAO();
$getAllJob = $jobDAO->getAllJob();
foreach($getAllJob as $keyJob => $valJob)
{
	$job_id = $valJob['job_id'];
	$job_title = $valJob['job_title'];
	$job_desc = $valJob['job_desc'];
	$salary_id = $valJob['salary_id'];

	echo "<tr>";
		echo "<td>";
		echo "<center>";
		echo "<a class = \"btn btn-primary btn-xs\" href=\"lib_jobedit.php?job_id=".$job_id." \">Edit</a><br/><br/>";
		echo "</center>";
		echo "</td>";
		...
		$getSalaryByID = $jobDAO->getSalaryByID($salary_id);
		echo "<td>";
		foreach($getSalaryByID as $key=>$val)
		{
			echo $val['salary_amount'];	
		}
