...
define("EW_PROJECT_NAME", "hris", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{385D4C96-0DB9-4CC6-ACC4-87310A278BE6}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '6Onc5YppkHQGJiCl', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/hris.css", TRUE); // Project stylesheet file name
...
//define("EW_CONN_PASS", '', TRUE);
 define("EW_CONN_PASS", '', TRUE);
define("EW_CONN_DB", 'db_hris', TRUE);

/*define("EW_CONN_HOST", '10.10.10.32', TRUE);
define("EW_CONN_PORT", 3306, TRUE);
define("EW_CONN_USER", 'phptest', TRUE);
define("EW_CONN_PASS", 'phpt35t2', TRUE);
define("EW_CONN_DB", 'db_cmalvarez', TRUE);*/
...
define("EW_SENDER_EMAIL", "no-reply-hris", TRUE); // Sender email address
