...
<?php include "model/leaveCoverageDAO.php" ?>
...
<table border="1" width="100%" class ="table table-striped table-bordered table-hover">
	<tr>
		<td colspan="9"><a href="leave_application_u_add.php" class="btn btn-sm btn-purple">Apply For Leave</a></td>
	</tr>
	<tr>
		<td colspan = 9>
		<b>
...
foreach($getLeavePerEMP as $key=>$val)
{
	...
	$getEmpByID = $leaveApplicationDAO->getEmpByID($emp_id);
	echo "<td>";
