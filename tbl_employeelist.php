...
<?php include "model/createDTRDAO.php" ?>
<?php
...
//if($_GET['emp_id'] <> "" || $_GET['emp_id'] == NULL)
if($_SESSION['hris_Success_Message'] == "Add Succeeded")
{

	//echo "ADD DTR";
	include "createDtrAuto.php";
...
<?php if ($tbl_employee->CurrentAction <> "gridadd" && $tbl_employee->CurrentAction <> "gridedit") { ?>
<form name="ewPagerForm" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>">
<table class="ewPager">
<tr><td>
<?php if (!isset($tbl_employee_list->Pager)) $tbl_employee_list->Pager = new cNumericPager($tbl_employee_list->StartRec, $tbl_employee_list->DisplayRecs, $tbl_employee_list->TotalRecs, $tbl_employee_list->RecRange) ?>
<?php if ($tbl_employee_list->Pager->RecordCount > 0) { ?>
<table cellspacing="0" class="table"><tbody><tr><td>
<div class="pagination"><ul>
	<?php if ($tbl_employee_list->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $tbl_employee_list->PageUrl() ?>start=<?php echo $tbl_employee_list->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($tbl_employee_list->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $tbl_employee_list->PageUrl() ?>start=<?php echo $tbl_employee_list->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($tbl_employee_list->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $tbl_employee_list->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($tbl_employee_list->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $tbl_employee_list->PageUrl() ?>start=<?php echo $tbl_employee_list->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($tbl_employee_list->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $tbl_employee_list->PageUrl() ?>start=<?php echo $tbl_employee_list->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</td>
<td>
	<?php if ($tbl_employee_list->Pager->ButtonCount > 0) { ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php } ?>
	<?php echo $Language->Phrase("Record") ?>&nbsp;<?php echo $tbl_employee_list->Pager->FromIndex ?>&nbsp;<?php echo $Language->Phrase("To") ?>&nbsp;<?php echo $tbl_employee_list->Pager->ToIndex ?>&nbsp;<?php echo $Language->Phrase("Of") ?>&nbsp;<?php echo $tbl_employee_list->Pager->RecordCount ?>
</td>
</tr></tbody></table>
<?php } else { ?>
	<?php if ($Security->CanList()) { ?>
	<?php if ($tbl_employee_list->SearchWhere == "0=101") { ?>
...
<?php if ($tbl_employee_list->TotalRecs > 0) { ?>
<td>
	&nbsp;&nbsp;&nbsp;&nbsp;
<input type="hidden" name="t" value="tbl_employee">
<select name="<?php echo EW_TABLE_REC_PER_PAGE ?>" class="input-small" onchange="this.form.submit();">
<option value="10"<?php if ($tbl_employee_list->DisplayRecs == 10) { ?> selected="selected"<?php } ?>>10</option>
<option value="20"<?php if ($tbl_employee_list->DisplayRecs == 20) { ?> selected="selected"<?php } ?>>20</option>
<option value="50"<?php if ($tbl_employee_list->DisplayRecs == 50) { ?> selected="selected"<?php } ?>>50</option>
<option value="100"<?php if ($tbl_employee_list->DisplayRecs == 100) { ?> selected="selected"<?php } ?>>100</option>
<option value="ALL"<?php if ($tbl_employee->getRecordsPerPage() == -1) { ?> selected="selected"<?php } ?>><?php echo $Language->Phrase("AllRecords") ?></option>
</select>
</td>
<?php } ?>
</tr></table>
...
<?php
	foreach ($tbl_employee_list->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
</div>
<?php } ?>
<form name="ftbl_employeelist" id="ftbl_employeelist" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="tbl_employee">
<div id="gmp_tbl_employee" class="ewGridMiddlePanel">
<?php if ($tbl_employee_list->TotalRecs > 0) { ?>
<table id="tbl_tbl_employeelist" class="table table-hover">
<?php
	echo "<input type = 'hidden' id = $emp_id name = $emp_id value = '".$emp_id."' />";
?>
...
// Render list options
$tbl_employee_list->RenderListOptions();

// Render list options (header, left)
$tbl_employee_list->ListOptions->Render("header", "left");
?>
<?php /*
<?php if ($tbl_employee->emp_id->Visible) { // emp_id ?>
	<?php if ($tbl_employee->SortUrl($tbl_employee->emp_id) == "") { ?>
		<td><div id="elh_tbl_employee_emp_id" class="tbl_employee_emp_id"><div class="ewTableHeaderCaption"><?php echo $tbl_employee->emp_id->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $tbl_employee->SortUrl($tbl_employee->emp_id) ?>',1);"><div id="elh_tbl_employee_emp_id" class="tbl_employee_emp_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $tbl_employee->emp_id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($tbl_employee->emp_id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($tbl_employee->emp_id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
*/ ?>
...
<?php if ($tbl_employee->empFirstName->Visible) { // empFirstName ?>
	<?php if ($tbl_employee->SortUrl($tbl_employee->empFirstName) == "") { ?>
		<td><div id="elh_tbl_employee_empFirstName" class="tbl_employee_empFirstName"><div class="ewTableHeaderCaption"><?php echo $tbl_employee->empFirstName->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $tbl_employee->SortUrl($tbl_employee->empFirstName) ?>',1);"><div id="elh_tbl_employee_empFirstName" class="tbl_employee_empFirstName">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $tbl_employee->empFirstName->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($tbl_employee->empFirstName->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($tbl_employee->empFirstName->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($tbl_employee->empMiddleName->Visible) { // empMiddleName ?>
	<?php if ($tbl_employee->SortUrl($tbl_employee->empMiddleName) == "") { ?>
		<td><div id="elh_tbl_employee_empMiddleName" class="tbl_employee_empMiddleName"><div class="ewTableHeaderCaption"><?php echo $tbl_employee->empMiddleName->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $tbl_employee->SortUrl($tbl_employee->empMiddleName) ?>',1);"><div id="elh_tbl_employee_empMiddleName" class="tbl_employee_empMiddleName">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $tbl_employee->empMiddleName->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($tbl_employee->empMiddleName->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($tbl_employee->empMiddleName->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($tbl_employee->empLastName->Visible) { // empLastName ?>
	<?php if ($tbl_employee->SortUrl($tbl_employee->empLastName) == "") { ?>
		<td><div id="elh_tbl_employee_empLastName" class="tbl_employee_empLastName"><div class="ewTableHeaderCaption"><?php echo $tbl_employee->empLastName->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $tbl_employee->SortUrl($tbl_employee->empLastName) ?>',1);"><div id="elh_tbl_employee_empLastName" class="tbl_employee_empLastName">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $tbl_employee->empLastName->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($tbl_employee->empLastName->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($tbl_employee->empLastName->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($tbl_employee->empExtensionName->Visible) { // empExtensionName ?>
	<?php if ($tbl_employee->SortUrl($tbl_employee->empExtensionName) == "") { ?>
		<td><div id="elh_tbl_employee_empExtensionName" class="tbl_employee_empExtensionName"><div class="ewTableHeaderCaption"><?php echo $tbl_employee->empExtensionName->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $tbl_employee->SortUrl($tbl_employee->empExtensionName) ?>',1);"><div id="elh_tbl_employee_empExtensionName" class="tbl_employee_empExtensionName">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $tbl_employee->empExtensionName->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($tbl_employee->empExtensionName->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($tbl_employee->empExtensionName->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($tbl_employee->sex_id->Visible) { // sex_id ?>
	<?php if ($tbl_employee->SortUrl($tbl_employee->sex_id) == "") { ?>
		<td><div id="elh_tbl_employee_sex_id" class="tbl_employee_sex_id"><div class="ewTableHeaderCaption"><?php echo $tbl_employee->sex_id->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $tbl_employee->SortUrl($tbl_employee->sex_id) ?>',1);"><div id="elh_tbl_employee_sex_id" class="tbl_employee_sex_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $tbl_employee->sex_id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($tbl_employee->sex_id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($tbl_employee->sex_id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($tbl_employee->schedule_id->Visible) { // schedule_id ?>
	<?php if ($tbl_employee->SortUrl($tbl_employee->schedule_id) == "") { ?>
		<td><div id="elh_tbl_employee_schedule_id" class="tbl_employee_schedule_id"><div class="ewTableHeaderCaption"><?php echo $tbl_employee->schedule_id->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $tbl_employee->SortUrl($tbl_employee->schedule_id) ?>',1);"><div id="elh_tbl_employee_schedule_id" class="tbl_employee_schedule_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $tbl_employee->schedule_id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($tbl_employee->schedule_id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($tbl_employee->schedule_id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($tbl_employee->salary_id->Visible) { // salary_id ?>
	<?php if ($tbl_employee->SortUrl($tbl_employee->salary_id) == "") { ?>
		<td><div id="elh_tbl_employee_salary_id" class="tbl_employee_salary_id"><div class="ewTableHeaderCaption"><?php echo $tbl_employee->salary_id->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $tbl_employee->SortUrl($tbl_employee->salary_id) ?>',1);"><div id="elh_tbl_employee_salary_id" class="tbl_employee_salary_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $tbl_employee->salary_id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($tbl_employee->salary_id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($tbl_employee->salary_id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($tbl_employee->tax_category_id->Visible) { // tax_category_id ?>
	<?php if ($tbl_employee->SortUrl($tbl_employee->tax_category_id) == "") { ?>
		<td><div id="elh_tbl_employee_tax_category_id" class="tbl_employee_tax_category_id"><div class="ewTableHeaderCaption"><?php echo $tbl_employee->tax_category_id->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $tbl_employee->SortUrl($tbl_employee->tax_category_id) ?>',1);"><div id="elh_tbl_employee_tax_category_id" class="tbl_employee_tax_category_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $tbl_employee->tax_category_id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($tbl_employee->tax_category_id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($tbl_employee->tax_category_id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($tbl_employee->date_hired->Visible) { // date_hired ?>
	<?php if ($tbl_employee->SortUrl($tbl_employee->date_hired) == "") { ?>
		<td><div id="elh_tbl_employee_date_hired" class="tbl_employee_date_hired"><div class="ewTableHeaderCaption"><?php echo $tbl_employee->date_hired->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $tbl_employee->SortUrl($tbl_employee->date_hired) ?>',1);"><div id="elh_tbl_employee_date_hired" class="tbl_employee_date_hired">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $tbl_employee->date_hired->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($tbl_employee->date_hired->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($tbl_employee->date_hired->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php
...
$tbl_employee_list->ListOptions->Render("header", "right");
?>
	</tr>
</thead>
<tbody>
<?php
if ($tbl_employee->ExportAll && $tbl_employee->Export <> "") {
	$tbl_employee_list->StopRec = $tbl_employee_list->TotalRecs;
} else {

	// Set the last record to display
	if ($tbl_employee_list->TotalRecs > $tbl_employee_list->StartRec + $tbl_employee_list->DisplayRecs - 1)
		$tbl_employee_list->StopRec = $tbl_employee_list->StartRec + $tbl_employee_list->DisplayRecs - 1;
	else
		$tbl_employee_list->StopRec = $tbl_employee_list->TotalRecs;
}
$tbl_employee_list->RecCnt = $tbl_employee_list->StartRec - 1;
if ($tbl_employee_list->Recordset && !$tbl_employee_list->Recordset->EOF) {
	$tbl_employee_list->Recordset->MoveFirst();
	if (!$bSelectLimit && $tbl_employee_list->StartRec > 1)
		$tbl_employee_list->Recordset->Move($tbl_employee_list->StartRec - 1);
} elseif (!$tbl_employee->AllowAddDeleteRow && $tbl_employee_list->StopRec == 0) {
	$tbl_employee_list->StopRec = $tbl_employee->GridAddRowCount;
}

// Initialize aggregate
$tbl_employee->RowType = EW_ROWTYPE_AGGREGATEINIT;
$tbl_employee->ResetAttrs();
$tbl_employee_list->RenderRow();
while ($tbl_employee_list->RecCnt < $tbl_employee_list->StopRec) {
	$tbl_employee_list->RecCnt++;
	if (intval($tbl_employee_list->RecCnt) >= intval($tbl_employee_list->StartRec)) {
		$tbl_employee_list->RowCnt++;

		// Set up key count
		$tbl_employee_list->KeyCount = $tbl_employee_list->RowIndex;

		// Init row class and style
		$tbl_employee->ResetAttrs();
		$tbl_employee->CssClass = "";
		if ($tbl_employee->CurrentAction == "gridadd") {
		} else {
			$tbl_employee_list->LoadRowValues($tbl_employee_list->Recordset); // Load row values
		}
		$tbl_employee->RowType = EW_ROWTYPE_VIEW; // Render view

		// Set up row id / data-rowindex
		$tbl_employee->RowAttrs = array_merge($tbl_employee->RowAttrs, array('data-rowindex'=>$tbl_employee_list->RowCnt, 'id'=>'r' . $tbl_employee_list->RowCnt . '_tbl_employee', 'data-rowtype'=>$tbl_employee->RowType));
...
$tbl_employee_list->ListOptions->Render("body", "left", $tbl_employee_list->RowCnt);
?>
<?php /*
	<?php if ($tbl_employee->emp_id->Visible) { // emp_id ?>
...
<a id="<?php echo $tbl_employee_list->PageObjName . "_row_" . $tbl_employee_list->RowCnt ?>"></a></td>
	<?php } ?>
	*/ ?>
	<td>
	<a href = "tbl_employee_leavecreditlist.php?showmaster=tbl_employee&emp_id=<?php echo $tbl_employee->emp_id->CurrentValue; ?>" > Leave Credits</a>
	</td>
	<?php if ($tbl_employee->empFirstName->Visible) { // empFirstName ?>
...
$tbl_employee_list->ListOptions->Render("body", "right", $tbl_employee_list->RowCnt);
?>
	</tr>
<?php
	}
	if ($tbl_employee->CurrentAction <> "gridadd")
		$tbl_employee_list->Recordset->MoveNext();
}
?>
</tbody>
</table>
<?php } ?>
<?php if ($tbl_employee->CurrentAction == "") { ?>
...
// Close recordset
if ($tbl_employee_list->Recordset)
	$tbl_employee_list->Recordset->Close();
?>
<?php if ($tbl_employee_list->TotalRecs > 0) { ?>
<?php if ($tbl_employee->Export == "") { ?>
