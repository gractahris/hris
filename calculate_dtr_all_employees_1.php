...
<table class = "table table-hover">
	...
	<tr>
		...
		if($is_holiday == 1)
		{
			...
			$emp_timein = "NULL";
			$emp_timeout = "NULL";
			$saveTimeIN = $timesheetDAO->saveAbsent($emp_id,$emp_timein,$emp_timeout, $emp_totalhours,$emp_late,$emp_excesstime,$emp_undertime,$dtr_id);
		...
		$getDTR = $timesheetDAO->getDTR($emp_id,$month,$dateDay,$dateYear);
		$getDTRIfAbsent = $timesheetDAO->getDTR($emp_id,$month,$dateLessNow,$dateYear);
		$dtr_idAbsent = $getDTRIfAbsent[0]['dtr_id'];
		$dtr_idToday = $getDTR[0]['dtr_id'];
		echo "DTR_ID_Today=>".$dtr_idToday;echo "<br/>";
