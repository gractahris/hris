...
$getEmpByID = $employeeDAO->getEmpByID($_GET['emp_id']);

foreach($getEmpByID as $key=>$val)
{
	echo "<tr>";
		echo "<td>";
		echo "FIRST NAME";
		...
		echo "<td>";
		echo "<input type=\"text\" id = \"first_name\" name=\"first_name\" value = \"".$val['empFirstName']."\" />";
		echo "</td>";
	...
	echo "<tr>";
		...
		echo "<td>";
		echo "<input type=\"text\" id = \"middle_name\" name=\"middle_name\"  value = \"".$val['empMiddleName']."\" />";
		echo "</td>";
	...
	echo "<tr>";
		...
		echo "<td>";
		echo "<input type=\"text\" id = \"last_name\" name=\"last_name\"  value = \"".$val['empLastName']."\" />";
		echo "</td>";
	...
	echo "<tr>";
		...
		echo "<td>";
		echo "<input type=\"text\" id = \"ext_name\" name=\"ext_name\" value = \"".$val['empExtensionName']."\" />";
		echo "</td>";
	...
	echo "<tr>";
		...
		foreach($getAllSchedule as $keySched => $valSched)
		{
			...
			echo "' value='";
			echo $valSched['schedule_id']."'";
			if($val['schedule_id'] == $valSched['schedule_id'])
			{
				echo "selected";
			}else
			{
	...
	echo "<tr>";
		...
		foreach($getAllSalary as $keySalary => $valSalary)
		{
			...
			echo "' value='";
			echo $valSalary['salary_id']."'";
			if($val['salary_id'] == $valSalary['salary_id'])
			{
				echo "selected";
			}else
			{
	...
	echo "<tr>";
		...
		foreach($getAllTaxCat as $keyTax => $valTax)
		{
			...
			echo "' value='";
			echo $valTax['tax_category_id']."'";
			if($val['tax_category_id'] == $valTax['tax_category_id'])
			{
				echo "selected";
			}else
			{
	...
	echo "<tr>";
		...
		echo "<td>";
		echo "<input type=\"text\" id = \"date_hired\" name=\"date_hired\" value = \"".$val['date_hired']."\" />";
		echo "</td>";
	...
	echo "<tr>";
		...
		echo "<td colspan = 2>";
		echo "<center>";
		echo "<input class=\"btn btn-sm btn-purple\" type=\"submit\" name=\"btnSave\" id=\"btnSave\" value=\"Edit Employee\">";
		echo "</center>";
		echo "</td>";
		
	echo "</tr>";

	echo "<input type =\"hidden\" id=\"emp_id\" name =\"emp_id\" value=\"".$val['emp_id']."\" />";
...
$empLastName = $_GET['last_name'];
$empFirstName = $_GET['first_name'];
$empMiddleName = $_GET['middle_name'];
$empExtensionName = $_GET['ext_name'];
$sex_id = $_GET['sex_id'];
$schedule_id = $_GET['schedule_id'];
$salary_id = $_GET['salary_id'];
$tax_category_id = $_GET['tax_category_id'];
...
if(isset($_GET['btnSave']))
{
	...
	if($empFirstName <> "" && $empLastName <> "" && $sex_id <> "" && $salary_id <> "" && $tax_category_id <> "" && $date_hired <> "" && $job_id <> "")
	{
		$saveEmp = $employeeDAO->updateEmp($empLastName,
							$empFirstName,
							$empMiddleName,
							$empExtensionName,
							$sex_id,
