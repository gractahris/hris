...
$emp_id = $_GET['emp_id'];
echo "<input type=\"text\" value=\"$emp_id\" id=\"emp_id\" name=\"emp_id\" />";
...
echo "<tr>";
	...
	echo "<td>";
	echo "<input type=\"text\" id=\"d_title\" name=\"d_title\" />";
	echo "</td>";
echo "</tr>";
...
echo "<tr>";
	...
	echo "<td>";
	echo "<input type=\"text\" id=\"d_amount\" name=\"d_amount\" />";
	echo "</td>";
echo "</tr>";
...
echo "<tr>";
	echo "<td colspan = \"2\">";
	echo "<center>";
	echo "<input type=\"submit\" name=\"btnAdd\" id=\"btnAdd\" value=\"Add Deduction\">";
	echo "</center>";
	echo "</td>";
echo "</tr>";
...
if(isset($_GET['btnAdd']))
{
	...
	$emp_id = $_GET['emp_id'];
	$cut_off_id = $_GET['cut_off_id'];

	if($cut_off_id == "" || $cut_off_id  == NULL || $cut_off_id  == "#")
	{
		?>
			<script>
			alert("Enter Cut Off Dates");
			</script>
		<?php
	}
	...
	{
		$saveOD = $employeeDeductionDAO->saveOtherDeduction($emp_id,$d_title,$d_amount,$month_id,$year_id,$cut_off_id);
		?>
