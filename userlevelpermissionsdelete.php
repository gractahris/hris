...
// No functions
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("list", "<span id=\"ewPageCaption\">" . $PageCaption . "</span>", "userlevelpermissionslist.php", $this->TableVar);
...
?>
<form name="fuserlevelpermissionsdelete" id="fuserlevelpermissionsdelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
