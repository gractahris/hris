...
$tbl_leavecoverage_view = NULL; // Initialize page object first

class ctbl_leavecoverage_view extends ctbl_leavecoverage {
	...
	// Page object name
	var $PageObjName = 'tbl_leavecoverage_view';
	...
	function __construct() {
		...
		if (@$_GET["leave_coverage_id"] <> "") {
			$this->RecKey["leave_coverage_id"] = $_GET["leave_coverage_id"];
			$KeyUrl .= "&leave_coverage_id=" . urlencode($this->RecKey["leave_coverage_id"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["leave_coverage_id"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["leave_coverage_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["leave_coverage_id"] <> "") {
				...
				$this->RecKey["leave_coverage_id"] = $this->leave_coverage_id->QueryStringValue;
			} else {
				$sReturnUrl = "tbl_leavecoveragelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tbl_leavecoveragelist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "tbl_leavecoveragelist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$item->Body = "<a id=\"emf_tbl_leavecoverage\" href=\"javascript:void(0);\" class=\"ewExportLink ewEmail\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_tbl_leavecoverage',hdr:ewLanguage.Phrase('ExportToEmail'),f:document.ftbl_leavecoverageview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false});\">" . $Language->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($tbl_leavecoverage_view)) $tbl_leavecoverage_view = new ctbl_leavecoverage_view();

// Page init
$tbl_leavecoverage_view->Page_Init();

// Page main
$tbl_leavecoverage_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbl_leavecoverage_view->Page_Render();
?>
...
// Page object
var tbl_leavecoverage_view = new ew_Page("tbl_leavecoverage_view");
tbl_leavecoverage_view.PageID = "view"; // Page ID
var EW_PAGE_ID = tbl_leavecoverage_view.PageID; // For backward compatibility

// Form object
var ftbl_leavecoverageview = new ew_Form("ftbl_leavecoverageview");

// Form_CustomValidate event
ftbl_leavecoverageview.Form_CustomValidate = 
...
ftbl_leavecoverageview.ValidateRequired = true;
<?php } else { ?>
ftbl_leavecoverageview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftbl_leavecoverageview.Lists["x_emp_id"] = {"LinkField":"x_emp_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_empLastName","x_empFirstName","x_empMiddleName",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $tbl_leavecoverage_view->ExportOptions->Render("body") ?>
<?php if (!$tbl_leavecoverage_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($tbl_leavecoverage_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $tbl_leavecoverage_view->ShowPageHeader(); ?>
<?php
$tbl_leavecoverage_view->ShowMessage();
?>
<form name="ftbl_leavecoverageview" id="ftbl_leavecoverageview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="tbl_leavecoverage">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_tbl_leavecoverageview" class="table table-bordered table-striped">
...
<?php if ($tbl_leavecoverage->leave_application_id->Visible) { // leave_application_id ?>
	<tr id="r_leave_application_id">
		<td><span id="elh_tbl_leavecoverage_leave_application_id"><?php echo $tbl_leavecoverage->leave_application_id->FldCaption() ?></span></td>
		<td<?php echo $tbl_leavecoverage->leave_application_id->CellAttributes() ?>>
<span id="el_tbl_leavecoverage_leave_application_id" class="control-group">
...
<?php if ($tbl_leavecoverage->emp_id->Visible) { // emp_id ?>
	<tr id="r_emp_id">
		<td><span id="elh_tbl_leavecoverage_emp_id"><?php echo $tbl_leavecoverage->emp_id->FldCaption() ?></span></td>
...
<?php if ($tbl_leavecoverage->date_from->Visible) { // date_from ?>
	<tr id="r_date_from">
		<td><span id="elh_tbl_leavecoverage_date_from"><?php echo $tbl_leavecoverage->date_from->FldCaption() ?></span></td>
...
<?php if ($tbl_leavecoverage->date_to->Visible) { // date_to ?>
	<tr id="r_date_to">
		<td><span id="elh_tbl_leavecoverage_date_to"><?php echo $tbl_leavecoverage->date_to->FldCaption() ?></span></td>
...
<script type="text/javascript">
ftbl_leavecoverageview.Init();
</script>
<?php
$tbl_leavecoverage_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($tbl_leavecoverage->Export == "") { ?>
...
<?php
$tbl_leavecoverage_view->Page_Terminate();
?>
