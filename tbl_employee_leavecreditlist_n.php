...
echo "<tr>";
	...
	foreach($getAllLeaveType as $key=>$val)
	{
		...
		// echo "<option value=\"".$leave_type_id_val."\" >".$leave_type_title."</option>";
			...
			echo "' value='";
			echo $leave_type_id_val;
			echo "' >".$leave_type_title_val."</option>";
	}
	echo "</select>";
	echo "</td>";
echo "</tr>";
...
echo "<tr>";
	...
	echo "<td>";
	echo "<input type=\"text\" id=\"leave_credit\" name=\"leave_credit\" />";
	echo "</td>";
echo "</tr>";
...
echo "<tr>";
	echo "<td colspan = \"2\">";
	echo "<center>";
	echo "<input type=\"submit\" name=\"btnAdd\" id=\"btnAdd\" value=\"Add Leave\">";
	echo "</center>";
	echo "</td>";
echo "</tr>";
...
if(isset($_GET['btnAdd']))
{
	...
	{
		$leaveCreditDAO->saveLeaveType($emp_id,$leave_type_id,$leave_credit);
