...
$tbl_employee_deduction_view = NULL; // Initialize page object first

class ctbl_employee_deduction_view extends ctbl_employee_deduction {
	...
	// Page object name
	var $PageObjName = 'tbl_employee_deduction_view';
	...
	function __construct() {
		...
		if (@$_GET["deduction_ref_id"] <> "") {
			$this->RecKey["deduction_ref_id"] = $_GET["deduction_ref_id"];
			$KeyUrl .= "&deduction_ref_id=" . urlencode($this->RecKey["deduction_ref_id"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["deduction_ref_id"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["deduction_ref_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["deduction_ref_id"] <> "") {
				...
				$this->RecKey["deduction_ref_id"] = $this->deduction_ref_id->QueryStringValue;
			} else {
				$sReturnUrl = "tbl_employee_deductionlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "tbl_employee_deductionlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "tbl_employee_deductionlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($tbl_employee_deduction_view)) $tbl_employee_deduction_view = new ctbl_employee_deduction_view();

// Page init
$tbl_employee_deduction_view->Page_Init();

// Page main
$tbl_employee_deduction_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$tbl_employee_deduction_view->Page_Render();
?>
...
// Page object
var tbl_employee_deduction_view = new ew_Page("tbl_employee_deduction_view");
tbl_employee_deduction_view.PageID = "view"; // Page ID
var EW_PAGE_ID = tbl_employee_deduction_view.PageID; // For backward compatibility

// Form object
var ftbl_employee_deductionview = new ew_Form("ftbl_employee_deductionview");

// Form_CustomValidate event
ftbl_employee_deductionview.Form_CustomValidate = 
...
ftbl_employee_deductionview.ValidateRequired = true;
<?php } else { ?>
ftbl_employee_deductionview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ftbl_employee_deductionview.Lists["x_deduction_id"] = {"LinkField":"x_deduction_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_deduction_title","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $tbl_employee_deduction_view->ExportOptions->Render("body") ?>
<?php if (!$tbl_employee_deduction_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($tbl_employee_deduction_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php } ?>
<?php $tbl_employee_deduction_view->ShowPageHeader(); ?>
<?php
$tbl_employee_deduction_view->ShowMessage();
?>
<form name="ftbl_employee_deductionview" id="ftbl_employee_deductionview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="tbl_employee_deduction">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_tbl_employee_deductionview" class="table table-bordered table-striped">
...
<?php if ($tbl_employee_deduction->deduction_id->Visible) { // deduction_id ?>
	<tr id="r_deduction_id">
		<td><span id="elh_tbl_employee_deduction_deduction_id"><?php echo $tbl_employee_deduction->deduction_id->FldCaption() ?></span></td>
...
<?php if ($tbl_employee_deduction->deduction_amount->Visible) { // deduction_amount ?>
	<tr id="r_deduction_amount">
		<td><span id="elh_tbl_employee_deduction_deduction_amount"><?php echo $tbl_employee_deduction->deduction_amount->FldCaption() ?></span></td>
...
<span id="el_tbl_employee_deduction_emp_id" class="control-group">
...
<script type="text/javascript">
ftbl_employee_deductionview.Init();
</script>
<?php
$tbl_employee_deduction_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($tbl_employee_deduction->Export == "") { ?>
...
<?php
$tbl_employee_deduction_view->Page_Terminate();
?>
