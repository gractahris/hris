...
$getAllMonth = array("Jan","Feb","Mar","Apr","May","Jun","July","Aug","Sept","Oct","Nov","Dec");
			...
			if ($counterMonth < '08')
			{
				if($counterMonth % 2 == 1)
				{
					for($counter = 1; $counter <= 31; $counter++)
					{
						...
						// echo $counter;
						// echo "=>";
						$yearNow = $getYearNow[0]['YearNow'];
						// echo $yearNow;
						// echo "=>";
						$getAllEmp2 = $createDTRDAO->getAllEmp2($counterMonth,$yearNow);
						foreach($getAllEmp2 as $keyEmp => $valEmp)
						{
							//echo $valEmp['emp_id'];
							$saveDTR = $createDTRDAO->saveDTR($valEmp['emp_id'],$counterMonth,$counter,$yearNow);
