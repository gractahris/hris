...
class ccustompage {
	...
	// Project ID
	var $ProjectID = "{785D4C96-0DB9-4CC6-ACC4-87710A278BE6}";
...
foreach($getPayroll as $keyPr => $valPr)
{
	...
	echo "<td align = 'left' colspan = 5>";
	echo $valPr["pagibig_cont_ee"];
	echo "</td>";
	echo "</tr>";
	
	echo "<tr>";
	echo "<td align = 'right' colspan = 7>";	
	echo "WITHHOLDING TAX: ";
	echo "</td>";
	...
	$totalDeduction = $valPr["sss_cont_ee"]+$valPr["ph_cont_ee"]+$valPr["pagibig_cont_ee"]+$valPr["tax_cont"];
