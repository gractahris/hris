...
<table width="100%" class = "table table-striped table-bordered table-hover">
	<tr>
		<td>JOB TITLE</td>
		<td><input type="text" size="60" id="jobTitle" name = "jobTitle"></td>
	</tr>

	<tr>
		<td>JOB DESCRIPTION</td>
		<td><input type="text" size="60" id="jobDesc" name = "jobDesc"></td>
	</tr>
	<tr>
		<td>SALARY</td>
		<td>
		...
		// print_r($getAllSalary);
		foreach($getAllSalary as $key =>$val)
		{
			echo "<option value = \" ".$val['salary_id']."\"";
			echo ">";
	...
	<tr>
	<td  colspan = "2" ><input class="btn btn-sm btn-purple" type="submit" id="btnAdd" name = "btnAdd" value = "Add Job"></td>
	</tr>
...
if(isset($_GET['btnAdd']))
{
	...
	$saveJob = $jobDAO->saveJob($job_title,$job_desc,$salary_id);
