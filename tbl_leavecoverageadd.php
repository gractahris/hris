...
<?php
//$action = "tbl_leavecoverageadd1.php";

?>
<form method = "GET" action = "tbl_leavecoverageadd.php">

<?php

//echo "carlaaaaaaaaaaaaaa";
$daysToLeave = $_SESSION['daysToLeave'];
// echo "daysToLeave => ".$daysToLeave;
// echo "<br/>";
$emp_id = $_SESSION['emp_id'];
// echo "emp_id => ".$emp_id;
// echo "<br/>";
$leave_application_id = $_SESSION['hris_tbl_leavecoverage_x_leave_application_id_SessionValue'];
// echo "leave_application_id => ".$leave_application_id;
//$dayDiff = "";
...
<table cellspacing="10" cellpadding="20" class = "table table-hover" width = "100%">

<tr>
	<td>Days Applied For Leave
	</td>

	<td>:</td>

	<td><?php echo $daysToLeave . " days"; ?>
	</td>
</tr>
...
<tr>
	<td colspan = "3" align="center">
		<input type="submit" id="btnSaveLeave" name = "btnSaveLeave" value="Add" />
	</td>
</tr>
</table>
</form>
...
<?php
	...
	if($_GET["btnSaveLeave"] == "Add")
	{
		$dateFrom = $_GET['dateFrom'];
		$arrOfDateFrom = explode('-', $dateFrom);

		$dateTo = $_GET['dateTo'];
		$arrOfDateTo = explode('-', $dateTo);
		...
		// echo "<br/>";
		if($dayDiff > $daysToLeave || $dayDiff < $daysToLeave)
		{
		?>

			<script>
			alert("Days indicated are not equal to days applied");
			</script>
		<?php	
		...
		else
		{
			...
			for($counter = 1; $counter <= $daysToLeave; $counter++)
			{
				//echo $counter;
				$dateFromInc = $yearFrom . "-" .$monthFrom. "-".$dayFrom;
				$saveLeaveCoverage = $leaveApplicationDAO->saveLeaveCoverage($leave_application_id, $emp_id, $dateFromInc, $dateFromInc);
				

				$getDTR = $timesheetDAO->getDTR($emp_id,$monthFrom, $dayFrom, $yearFrom);echo "<br/>";
				$getDtrID = $getDTR[0]['dtr_id'];
				//echo $getDtrID; echo "<br/>";

				$dtrIdInEmpTimelog = $timesheetDAO->dtrIdInEmpTimelog($getDtrID);
				if($dtrIdInEmpTimelog == true)
				{
					//echo "aaaaaaaaaaaa";
				...
				}else
				{
					...
					$emp_timein = "NULL";
					$emp_timeout = "NULL";
					$emp_totalhours = "00:00:00";
					$emp_late = "00:00:00";
					$emp_excesstime = "00:00:00";
					$emp_undertime = "00:00:00";
					$saveLeaveStatus = $timesheetDAO->saveLeaveStatus($emp_id, $emp_timein,$emp_timeout,$emp_totalhours,$emp_late,$emp_excesstime,$emp_undertime,$getDtrID,$emp_leave_status);
