...
$getAllMonth = $holidayDAO->getAllMonth();
$getAllDay = $holidayDAO->getAllDay();
$getAllYear = $holidayDAO->getAllYear();
echo "<a href=\"lib_holiday_a_list.php\" class=\"btn btn-info btn-success icon-undo \">&nbsp;&nbsp;&nbsp;Back To List</a>";
echo "<br/><br/><br/>";
echo "<form method = \"GET\" action=\"lib_holiday_a_add.php\">";
echo "<table width = \"100%\" class = \"table table-bordered\">";
echo "<tr>";
	echo "<td>Holiday Title</td>";
	echo "<td><input type=\"text\" id =\"txtHTitle\" name =\"txtHTitle\" /></td>";
echo "</tr>";

echo "<tr>";
	echo "<td>Holiday Month</td>";
	echo "<td>";
	echo "<select name=\"holiday_month\">";
	echo "<option value=\"#\" id=\"#\" >Please Select</option>";
	foreach($getAllMonth as $keyMonth => $valMonth)
	{
		$month_val = $valMonth['month_val'];
		$month_title = $valMonth['month_title'];
		echo "<option value=\"$month_val\" id=\"$month_val\" ";
		echo ">";
		echo $month_val.",".$month_title;
		echo "</option>";
	}
	echo "</select>";
	echo "</td>";
...
echo "<tr>";
	echo "<td>Holiday Day</td>";
	echo "<td>";
	echo "<select name=\"holiday_day\">";
	echo "<option value=\"#\" id=\"#\" >Please Select</option>";
	foreach($getAllDay as $keyDay => $valDay)
	{
		$day_id = $valDay['day_id'];
		$day_title = $valDay['day_title'];
		echo "<option value=\"$day_title\" id=\"$day_title\" ";
		echo ">";
		echo $day_title;
		echo "</option>";
	}
...
echo "<tr>";
	echo "<td>Holiday Year</td>";
	echo "<td>";
	echo "<select name=\"holiday_year\">";
	echo "<option value=\"#\" id=\"#\" >Please Select</option>";
	foreach($getAllYear as $keyYear => $valYear)
	{
		$year_id = $valYear['year_id'];
		$year_val = $valYear['year_val'];
		echo "<option value=\"$year_val\" id=\"$year_val\" ";
		echo ">";
		echo $year_val;
		echo "</option>";
	}
...
echo "<tr>";
	...
	echo "<td>";
	echo "<select name=\"holiday_type\">";
	echo "<option value=\"#\" id=\"#\" >Please Select</option>";
	echo "<option value=\"1\" id=\"1\" >Regular Holiday</option>";
	echo "<option value=\"2\" id=\"2\" >Special Non-Working Holiday</option>";
	echo "</select>";
	echo "</td>";
echo "</tr>";

// echo "<tr>";
// 	echo "<td>Compensation Percentage</td>";
// 	echo "<td></td>";
// echo "</tr>";
...
echo "<tr>";
	echo "<td colspan=\"2\">
	<center>
	<input type=\"submit\" id=\"btnSave\" value = \"SAVE\" name=\"btnSave\" class=\"btn btn-pink btn-lg \" />
	</center>
	</td>";
	// echo "<td></td>";
echo "</tr>";
...
if($_GET['btnSave'] == 'SAVE')
{
	$holiday_title=$_GET['txtHTitle'];
	$holiday_month=$_GET['holiday_month'];
	$holiday_day=$_GET['holiday_day'];
	$holiday_year=$_GET['holiday_year'];
	$holiday_type=$_GET['holiday_type'];
	$holiday_payroll_val="";

	if($holiday_type== "1")
	{
		$holiday_payroll_val="1.00";
	}else
	{
		$holiday_payroll_val="0.30";
	}

	if($holiday_title == NULL)
	{
		?>
		<script>
		alert("Enter Holiday Title!");
		</script>

		<?php

	}elseif($holiday_month == NULL ||$holiday_month == "#")
	{
		?>
		<script>
	...
	}elseif($holiday_day == NULL ||$holiday_day == "#")
	{
		?>
		<script>
	...
	}elseif($holiday_year == NULL ||$holiday_year == "#")
	{
		?>
		<script>
	...
	}elseif($holiday_type == NULL ||$holiday_type == "#")
	{
		?>
		<script>
	...
	{
	$insertHoliday = $holidayDAO->insertHoliday($holiday_title, $holiday_month, $holiday_day, $holiday_year, $holiday_type, $holiday_payroll_val);
